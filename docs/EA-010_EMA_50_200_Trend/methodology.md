...
3. **Đòn bẩy (Leverage):** Chuẩn `1:500`.
...
2. **Báo cáo thử nghiệm (`Backtest/`):** Chứa file báo cáo chi tiết (`report.html`), biểu đồ đồ họa và file `README.md` tổng hợp các chỉ số chính.
