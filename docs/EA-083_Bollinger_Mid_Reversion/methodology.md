...
# EA-083 — Technical Documentation

## 1. Project Information

Project ID: EA-083

Name: Bollinger Mid Reversion
...
EA-083 implements a Bollinger Bands mean-reversion strategy.

The trading hypothesis is that price may reverse after rejecting an outer Bollinger Band and move back toward the middle band.

The strategy requires a bullish rejection candle for BUY entries and a bearish rejection candle for SELL entries.

The middle band acts as the primary dynamic exit target.
...
The strategy uses fixed lot sizing rather than percentage-of-equity position sizing.
