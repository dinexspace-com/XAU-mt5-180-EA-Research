...
#property description "EA-072 Asian_Range_Break"
...
input ulong InpMagicNumber = 123072;
...
input int InpRangeStartHour=0; input int InpRangeEndHour=8; input int InpTradeEndHour=16;
...
void OpenTrade(const int direction)
{
   ...
   const bool ok=(buy ? trade.Buy(InpLotSize,_Symbol,price,sl,tp,"EA-072")
                     : trade.Sell(InpLotSize,_Symbol,price,sl,tp,"EA-072"));
   const uint code=trade.ResultRetcode();
