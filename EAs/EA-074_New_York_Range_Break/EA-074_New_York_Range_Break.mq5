...
#property description "EA-074 New_York_Range_Break"
...
input ulong InpMagicNumber = 123074;
...
input int InpRangeStartHour=13; input int InpRangeEndHour=14; input int InpTradeEndHour=20;
...
void OpenTrade(const int direction)
{
   ...
   const bool ok=(buy ? trade.Buy(InpLotSize,_Symbol,price,sl,tp,"EA-074")
                     : trade.Sell(InpLotSize,_Symbol,price,sl,tp,"EA-074"));
   const uint code=trade.ResultRetcode();
