...
#property description "EA-073 London_Range_Break"
...
input ulong InpMagicNumber = 123073;
...
input int InpRangeStartHour=8; input int InpRangeEndHour=9; input int InpTradeEndHour=13;
...
void OpenTrade(const int direction)
{
   ...
   const bool ok=(buy ? trade.Buy(InpLotSize,_Symbol,price,sl,tp,"EA-073")
                     : trade.Sell(InpLotSize,_Symbol,price,sl,tp,"EA-073"));
   const uint code=trade.ResultRetcode();
